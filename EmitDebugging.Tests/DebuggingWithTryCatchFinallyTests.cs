...
{
	public sealed class DebuggingWithTryCatchFinallyTests 
		: DebuggingTests
	{
		...
		{
			using (var assembly = DebuggingTests.CreateDebuggingAssembly("MethodWithTryCatchFinally"))
			{
		...
		protected override string[] GetExpectedFileLines()
		{
			return new string[] 
			{
				".assembly MethodWithTryCatchFinally",
				"{",
				"	.class public sealed ansi MethodWithTryCatchFinally.SimpleClass extends object",
				"	{",
