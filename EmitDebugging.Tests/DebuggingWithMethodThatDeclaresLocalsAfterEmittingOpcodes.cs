...
namespace EmitDebugging.Tests
{
	...
	public sealed class DebuggingWithMethodThatDeclaresLocalsAfterEmittingOpcodes
		: DebuggingTests
	{
		...
		{
			using (var assembly = DebuggingTests.CreateDebuggingAssembly("MethodThatDeclaresLocalsAfterEmittingOpcodes"))
			{
		...
		protected override string[] GetExpectedFileLines()
		{
			return new string[] 
			{
				".assembly MethodThatDeclaresLocalsAfterEmittingOpcodes",
				"{",
				"	.class public sealed ansi MethodThatDeclaresLocalsAfterEmittingOpcodes.SimpleClass extends object",
				"	{",
